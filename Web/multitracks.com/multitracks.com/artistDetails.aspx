...
<body class="premium standard u-fix-fancybox-iframe">
    <form>
        ...
        <div class="wrapper mod-standard mod-gray" runat="server" id="detailDiv">
            ...
            <div class="discovery--container u-container">
                <main class="discovery--section">
                    ...
                    <section class="standard--holder">
                        <div class="discovery--section--header" id="songs">
                            <h2>Top Songs</h2>
                        ...
                        <ul id="playlist" class="song-list mod-new mod-menu">
                            <asp:Repeater runat="server" ID="songItems">
                                <ItemTemplate>
                                    <li class="song-list--item media-player--row">
                                        ...
                                        <div class="song-list--item--player-img media-player">
                                            <img class="song-list--item--player-img--img"
                                                ...
                                                src="<%#Eval("imageURL") %>" alt="<%#Eval("songName") %>">
                                        </div>
                                        ...
                                        <div class="song-list--item--right">
                                            ...
                                            <a class="song-list--item--secondary"><%#Convert.ToInt32(Eval("bpm")) %> BPM</a>
                                            <a class="song-list--item--secondary"><%#GetTimeSignature(Convert.ToInt32(Eval("timeSignature"))) %></a>
                                            <div class="song-list--item--icon--holder">
                                                <a href="#" class="song-list--item--icon--wrap" runat="server" visible='<%#Convert.ToBoolean(Eval("multitracks")) %>'>
                                                ...
                                                <a href="#" class="song-list--item--icon--wrap" runat="server" visible='<%#Convert.ToBoolean(Eval("customMix")) %>'>
                                                ...
                                                <a href="#" class="song-list--item--icon--wrap" runat="server" visible='<%#Convert.ToBoolean(Eval("chart")) %>'>
                                                ...
                                                <a href="#" class="song-list--item--icon--wrap" runat="server" visible='<%#Convert.ToBoolean(Eval("rehearsalMix")) %>'>
                                                ...
                                                <a href="#" class="song-list--item--icon--wrap" runat="server" visible='<%#Convert.ToBoolean(Eval("patches")) %>'>
                                                ...
                                                <a href="#" class="song-list--item--icon--wrap" runat="server" visible='<%#Convert.ToBoolean(Eval("proPresenter")) %>'>
                    ...
                    <div class="discovery--space-saver">
                        <section class="standard--holder">
                            <div class="discovery--section--header" id="albums">
                                <h2>Albums</h2>
                                        ...
                                        <ItemTemplate>
                                            <div class="media-item">
                                                <a class="media-item--img--link" href="#" tabindex="0">
                                                    <img class="media-item--img" alt="<%#Eval("title") %>" src="<%#Eval("imageURL") %>" srcset="<%#Eval("imageURL") %>, <%#Eval("imageURL") %> 2x">
                    ...
                    <section class="standard--holder">
                        ...
                        <div class="artist-details--biography biography">
                            <asp:Repeater runat="server" ID="bioItems">
                                <ItemTemplate>
        ...
        <div runat="server" id="notFound" visible="false">
            <p>Artist not found or artitstID doesn't provided</p>
        </div>
